...
> Create an iterator for generating pseudorandom numbers drawn from an [Erlang][erlang] distribution.
...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-erlang@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-erlang/tags). For example,

```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-erlang@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterator = require( 'path/to/vendor/umd/random-iter-erlang/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-erlang@umd/browser.js"></script>
```
...
Returns an iterator for generating pseudorandom numbers drawn from an [Erlang][erlang] distribution with parameters `k` (shape parameter) and `lambda` (rate parameter).
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-erlang.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-erlang

[test-image]: https://github.com/stdlib-js/random-iter-erlang/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-iter-erlang/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-erlang/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-erlang?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-erlang.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-erlang/main
...
[branches-url]: https://github.com/stdlib-js/random-iter-erlang/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-erlang/main/LICENSE
